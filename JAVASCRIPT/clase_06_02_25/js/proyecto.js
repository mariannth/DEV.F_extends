...
let outputProyectoJS = document.getElementById("output-proyectojs");
let resultadoProyectoJS = "";
...
resultadoProyectoJS += `El estudiante aprueba con: ${mensaje}<br>`;
outputProyectoJS.innerHTML = resultadoProyectoJS;
